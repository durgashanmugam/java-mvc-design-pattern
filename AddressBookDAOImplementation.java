    ...
    {   
       try
       {
          conn = DBConnection.getInstance().getConnect();
           ...
           qry = "insert into AddressBook values ('"+person.getName()+"','"+person.getMob()+"','"+person.getEmail()+"','"+person.getCity()+"','"+person.getGender()+"')";
     ...
     public void updatePerson(Person person,String name)
     {
         try
       {
           conn = DBConnection.getInstance().getConnect();
           st = conn.createStatement();
            String qry="update AddressBook set name='"+person.getName()+"',mob='"+person.getMob()+"',email='"+person.getEmail()+"',city='"+person.getCity()+"',gender='"+person.getGender()+"' where name='"+name+"'";
           st.executeUpdate(qry);
           conn.close();
        }
